...
from .models import Producto, Cliente, Empresa, Proveedor, Empleado, Comedor, Contacto, Habitacion, Reserva, Huesped, Pedido, Compra, Manual, Archivo
from .forms import ProductoForm, ClienteForm, EmpresaForm, ProveedorForm, EmpleadoForm, ComedorForm, ContactoForm, HabitacionForm, HuespedForm, ReservaForm, PedidoForm, CompraForm, ManualForm, ArchivoForm, CustomUserCreationForm
