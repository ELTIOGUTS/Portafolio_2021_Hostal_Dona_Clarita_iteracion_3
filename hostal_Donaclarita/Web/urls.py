...
minuta_semanal, contacto, listar_reserva, modificar_reserva, eliminar_reserva, habitaciones, ordenes_pedido, listar_pedido, modificar_pedido, eliminar_pedido, ordenes_compra, listar_compra, modificar_compra, eliminar_compra, agregar_huesped, listar_huesped, modificar_huesped, eliminar_huesped,modificar_archivo,eliminar_archivo, registrar, Pdf, Pdf2, upload
